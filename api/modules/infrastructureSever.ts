...
const INFRASTRUCTURE_GET = (url: string, params = {}, config?: AxiosRequestConfig) => service.get(`${prefix}${url}`, { params, ...config });
const INFRASTRUCTURE_POST = (url: string, param = {}, config?: AxiosRequestConfig) => service.post(`${prefix}${url}`, param, config);
